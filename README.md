...
A responsive personal portfolio website by **Elmar Lupogan**, built as part of the MST Connect PH Full-Stack Web Development Bootcamp. The site introduces me as an aspiring full-stack web developer and showcases my current skills, projects, contact information, and professional links.
...
### Home / Hero
Introduces **Elmar Lupogan** as an aspiring full-stack web developer and includes buttons for viewing projects and visiting GitHub.
...
```bash
git clone https://github.com/ElmarLupz/personal-portfolio.git
...
- `ElmarLupz` with your actual GitHub username
...
- `ElmarLupz.svg` with your real profile photo when ready
...
- GitHub: https://github.com/ElmarLupz
- LinkedIn: https://www.linkedin.com/in/ElmarLupz
